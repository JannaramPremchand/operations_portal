...
def my_cron_job():
    ...
    print("Cron Job Test Success")
    l = open('/home/ec2-user/portal/log/abcd.log','a')
    l.write("Hello World.."+str(datetime.now())+'\n')
    l.close()
...
#     class_id = ["209149ab-e27e-422b-a28e-1030659fa3ef","ea8f0b65-96a2-4d59-813c-fa180ef2ccf8","277bb6d3-421c-41e5-ad93-56bad11c39aa","df7fc257-5208-4c1c-9b78-285d85857437","9289f463-badc-4722-8b51-e6f1326a7f02","f68a0557-8ada-4c80-a1b4-e858d167acbc","5a72516a-e83c-41e2-8488-5fc6bfb93a73","b2477aba-6a7d-4bc6-bf1a-0eda09692af2","52a0fdaf-a384-441a-9b4c-a3e3576ecf6d","dc905322-4869-458d-b15a-369ecb3c7f63","8a200529-17b3-41aa-ac07-7aabcb35ca63","655af533-fdb0-43b9-b7ce-3b948a1fbd2e","3b9c9cd5-f6f1-46e7-8fd7-bbffcab1f3b5","04bbf987-7367-4d47-a4ff-8179e13dae38","1eb6c1b2-c0f8-414f-9796-3d32c5e0ae15","251dba57-e431-4ba1-82da-67e9a0245c0e","ba85d2d7-d89e-4d89-954c-5ac6e2f1667c","3827fc2e-bfe8-4a06-b828-51acb726eb9d","c01694b0-f53d-47b4-a315-23e0e42f595c","d8152416-5c58-4db9-806b-3c2d9f44de3e","bb590a72-be9b-490a-bde2-54ff12e0fe61","5c30e2ca-d0ec-4277-ad76-5559b04a7bed","9cfdd9bf-3b7a-43da-bb6a-e19990d4252e","12896ca3-2670-4b63-adca-10c6294ce448","5fb36fd3-c74e-4abc-88c1-11bec4764767","4088d5ef-f51b-47e1-932f-02b5ebfd5ff6","140bbf76-775b-4df9-b809-40630357c03b","e8dbb214-9c4f-4083-ba37-b08f43d418e8","4e2cec39-04fe-4bcd-aaa4-c46a9611dbcf","278d6018-c6cb-4f05-81bf-9cfce61840e2","a189a5d7-5387-45de-9da2-f07450fd8d88","fd286713-7c9c-4783-8a29-16ca33db2001"]
#     class_name = ["Aug2020Batch","OCT2020Batch","DecBatch2020","Feb2021WeekendFull-StackBatch","MarchFullstack2021","MarchFront-EndBatch2021","Aprilweek-endbatch2021","May-BackendBatch","JuneFull-stackBatch2021","FrontendReactBatchJune2021","AugustFrontendBatch2021","AugustFull-StackBatch2021","AugustWeekendBatch2021","AugustBack-EndBatch2021","AndroidSeptember2021Batch","NovemberFrontendBatch2021","OctDataAnalytics2021","NovemberFullstackBatch2021","Aug_Nodejs2021","NovFull-stackWeekendBatch","DecDataAnalyticsBatch2021","JanFullStackBatch2022","JanFrontendBatch2022","JanWeekendBatch2022","MarchDataAnalyticsWeekendBatch2022","November_Node2021","FlutterMarchBatch2022","NovemberFull-StackPythonBatch2021","April2022full-timeBatch","AprilWeekendbatch2022","Mayfrontendfulltimebatch2022","DataAnalyticsfulltimeMayBatch2022"]

#     # class_id = ["251dba57-e431-4ba1-82da-67e9a0245c0e"]
#     # class_name = ["OctDataAnalytics2021"]
...
#     from datetime import datetime
#     print("Cron Job Test Success")
#     l = open('F:/digi/portal_backup_26052022/log/abcd.log','a')
#     l.write("Hello cronjob.."+str(datetime.now())+'\n')
#     l.close()
#     engine = create_engine('sqlite:///db.sqlite3')
#     conn = engine.connect()
#     trans = conn.begin()

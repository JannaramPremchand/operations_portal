...
def create_event(token, subject, start, end, attendees=None, body=None, timezone='UTC'):
  ...
  # meeting_data = requests.post('{0}/me/events'.format(graph_url),
  #   headers=headers,
  #   data=json.dumps(new_event))

  data_meeting = json.loads(requests.post('{0}/me/events'.format(graph_url),
    headers=headers,
    data=json.dumps(new_event)).text)
  # print(data_meeting)
  # print(data_meeting['onlineMeeting']['joinUrl'])
  # meetingid = data_meeting['onlineMeeting']['joinUrl']
...
# <CreateEventSnippet>
def create_onlinemeetings(token, subject, start, end):
  # Create an event object
  # https://docs.microsoft.com/graph/api/resources/event?view=graph-rest-1.0
  new_event1 = {
    'subject': subject,
  ...
  data_meeting = json.loads(requests.post('{0}/me/onlineMeetings'.format(graph_url),
    headers=headers,
    data=json.dumps(new_event1)).text)
  print(data_meeting)
  return data_meeting
